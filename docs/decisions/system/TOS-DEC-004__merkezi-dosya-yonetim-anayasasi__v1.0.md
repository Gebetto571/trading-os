...
| MD-007 | `TOS-DEC-004__merkezi-dosya-yonetim-anayasasi__v1.0.md` | `docs/decisions/system/` | docs-manager / all-chats | Dosya anayasası ve fihrist | Kullanıcı tarafından merkezi yönetişim istendi | active / main | `main@0de5589` | 2026-08-03 / 2026-08-03 | supersedes MD-006,011,012,013 |
...
| MD-023 | `CURRENT.md` | `docs/status/` | codex-dev / all-chats | Tekil güncel durum | Yaşayan durum kaydı | active / main | `main@0de5589` | 2026-08-03 / 2026-08-03 | MD-024 |
