...
| MD-007 | `TOS-DEC-004__merkezi-dosya-yonetim-anayasasi__v1.0.md` | `docs/decisions/system/` | docs-manager / all-chats | Dosya anayasası ve fihrist | Kullanıcı tarafından merkezi yönetişim istendi | proposed / branch-only | `agent/market-data-completion@9112cde` | 2026-08-03 / 2026-08-03 | supersedes MD-006,011,012,013 |
...
| MD-015 | `market-data.md` | `docs/architecture/` | codex-dev / cloud-planner,codex-dev | Piyasa verisi mimarisi | Bağımsız yazılım bileşeni | proposed / branch-only | `agent/market-data-completion@9112cde` | 2026-08-03 / 2026-08-03 | MD-010, MD-024 |
...
| MD-023 | `CURRENT.md` | `docs/status/` | codex-dev / all-chats | Tekil güncel durum | Yaşayan durum kaydı | proposed / branch-only | `agent/market-data-completion@9112cde` | 2026-08-03 / 2026-08-03 | MD-024 |
| MD-024 | `2026-08-03-btcusdt-data-integrity.md` | `docs/reports/` | codex-dev / cloud-planner,codex-dev | BTCUSDT bütünlük kanıtı | Bağımsız doğrulama raporu | proposed / branch-only | `agent/market-data-completion@9112cde` | 2026-08-03 / 2026-08-03 | MD-010, MD-015, MD-023 |
